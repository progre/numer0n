...
declare module 'linqjs' {
    var Utils: {
        ...
        createEnumerable<T>(getEnumerator: () => linqjs.IEnumerator<T>): linqjs.IEnumerable<T>;
        createEnumerator<T>(initialize: () => void, tryGetNext: () => boolean, dispose: () => void): linqjs.IEnumerator<T>;
    ...
    function from(): linqjs.IEnumerable<any>; // empty
    function from<T>(obj: linqjs.IEnumerable<T>): linqjs.IEnumerable<T>;
    function from(obj: number): linqjs.IEnumerable<number>;
    function from(obj: boolean): linqjs.IEnumerable<boolean>;
    function from(obj: string): linqjs.IEnumerable<string>;
    function from<T>(obj: T[]): linqjs.IEnumerable<T>;
    function from<T>(obj: { length: number;[x: number]: T; }): linqjs.IEnumerable<T>;
    function from(obj: any): linqjs.IEnumerable< { key: string; value: any }>;
    function make<T>(element: T): linqjs.IEnumerable<T>;
    function matches<T>(input: string, pattern: RegExp): linqjs.IEnumerable<T>;
    function matches<T>(input: string, pattern: string, flags?: string): linqjs.IEnumerable<T>;
    ...
    function repeatWithFinalize<T>(initializer: () => T, finalizer: (element) => void): linqjs.IEnumerable<T>;
...
declare module linqjs {
    ...
    interface IEnumerable<T> {
        ...
        traverseDepthFirst<TResult>(func: (element: T) => any): IEnumerable<T>;
        traverseDepthFirst<TResult>(func: (element: T) => any, resultSelector?: (element: T, nestLevel: number) => TResult): IEnumerable<TResult>;
